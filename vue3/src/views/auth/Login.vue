...
.login-container {
  ...
  .login-bg-wrapper {
    ...
    .login-overlay {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(rgba(255, 255, 255, 0.7), rgba(145, 201, 235, 0.7));
    ...
    .login-box {
      ...
      .login-header {
        ...
        h1 {
          ...
          color: #333;
          margin-bottom: 10px;
          background: linear-gradient(to right, #41b883, #1982c3);
      ...
      .login-form-wrapper {
        ...
        .login-form {
          ...
          .login-button {
            ...
            height: 44px;
            font-size: 16px;
            background: linear-gradient(90deg, #41b883, #1982c3);
            border: none;
            transition: all 0.3s;
